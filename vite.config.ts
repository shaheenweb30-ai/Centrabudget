  ...
  server: {
    ...
    headers: {
      ...
      'Content-Security-Policy': mode === 'development' 
        ? "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https: https://vitals.vercel-insights.com https://cdn.paddle.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdn.paddle.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https:; connect-src 'self' https: https://cdn.paddle.com; frame-src https://*.paddle.com https://*.paddle.dev; object-src 'none'; base-uri 'self';"
